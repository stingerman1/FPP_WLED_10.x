async(page)=>{
 ...
 if(await frame.locator('#wled-theme-modes').isVisible())throw Error('Embedded controls can override host theme');
 ...
 if(await page.evaluate(()=>document.documentElement.dataset.bsTheme)!=='light')throw Error('Auto did not follow host theme');
