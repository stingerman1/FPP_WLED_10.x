...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        try:
            ...
            if path in ('/settings', '/login', '/token-access.js', '/config-editor.js', '/linux-ui.js', '/schedules.js', '/base.js', '/summary.js', '/backup.js', '/guided-tools.js', '/virtual-layout.js', '/access.js', '/network.js', '/device-controls.js', '/settings.css', '/theme.js', '/wled-theme.css'):
