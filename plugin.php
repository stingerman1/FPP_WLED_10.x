...
<section><h3>Lighting access</h3><p>Open WLED and choose <strong>Enable lighting controls</strong>. This authorizes lighting, preset and configuration changes and remembers this browser. FPP handles the runtime token automatically.</p><p><a href="plugin.php?plugin=FPP_WLED_10.x&amp;page=settings.php#runtime-access">Manage access in WLED settings</a></p><details><summary>Advanced: retrieve a token for an API client</summary><p>Only needed for external API clients or direct runtime access. Keep the token private.</p>
