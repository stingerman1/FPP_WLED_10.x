...
| Timers | Linux local weekday/hour/minute/preset schedules. Local nightlight modes 0/1/2: delayed brightness, brightness fade, selected-segment RGBW color fade. Countdown pauses through shows/quiet periods; restart leaves it stopped. Sunrise/sunset scheduling and nightlight mode 3 remain unavailable. |
